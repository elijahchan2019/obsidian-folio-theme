...
For manual installation, download `theme.css` and `manifest.json` from the [latest release](https://github.com/elijah7x/theme-folio/releases/latest) and place them in:
